...
namespace Keycloak.ApiClient.Net
{
    public partial class KeycloakClient
    {
        ...
        public async Task<IEnumerable<ClientScope>> GetClientScopesAsync(string realm) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/client-scopes")
            .GetJsonAsync<IEnumerable<ClientScope>>()
            .ConfigureAwait(false);

        public async Task<ClientScope> GetClientScopeAsync(string realm, string clientScopeId) => await GetBaseUrl(realm, true)
