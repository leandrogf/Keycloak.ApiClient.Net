...
namespace Keycloak.ApiClient.Net
{
	...
	{
		public async Task<Mapping> GetScopeMappingsAsync(string realm, string clientScopeId) => await GetBaseUrl(realm, true)
		...
		public async Task<IEnumerable<Role>> GetClientRolesForClientScopeAsync(string realm, string clientScopeId, string clientId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/client-scopes/{clientScopeId}/scope-mappings/clients/{clientId}")
		...
		public async Task<IEnumerable<Role>> GetAvailableClientRolesForClientScopeAsync(string realm, string clientScopeId, string clientId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/client-scopes/{clientScopeId}/scope-mappings/clients/{clientId}/available")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);

		public async Task<IEnumerable<Role>> GetEffectiveClientRolesForClientScopeAsync(string realm, string clientScopeId, string clientId) => await GetBaseUrl(realm, true)
		...
		public async Task<IEnumerable<Role>> GetRealmRolesForClientScopeAsync(string realm, string clientScopeId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/client-scopes/{clientScopeId}/scope-mappings/realm")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);
		...
		public async Task<IEnumerable<Role>> GetAvailableRealmRolesForClientScopeAsync(string realm, string clientScopeId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/client-scopes/{clientScopeId}/scope-mappings/realm/available")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);

		public async Task<IEnumerable<Role>> GetEffectiveRealmRolesForClientScopeAsync(string realm, string clientScopeId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/client-scopes/{clientScopeId}/scope-mappings/realm/composite")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);

		public async Task<Mapping> GetScopeMappingsForClientAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
		...
		public async Task<IEnumerable<Role>> GetClientRolesScopeMappingsForClientAsync(string realm, string clientId, string scopeClientId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/scope-mappings/clients/{scopeClientId}")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);
		...
		public async Task<IEnumerable<Role>> GetAvailableClientRolesForClientScopeForClientAsync(string realm, string clientId, string scopeClientId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/scope-mappings/clients/{scopeClientId}/available")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);

		public async Task<IEnumerable<Role>> GetEffectiveClientRolesForClientScopeForClientAsync(string realm, string clientId, string scopeClientId) => await GetBaseUrl(realm, true)
		...
		public async Task<IEnumerable<Role>> GetRealmRolesScopeMappingsForClientAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/scope-mappings/realm")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);
		...
		public async Task<IEnumerable<Role>> GetAvailableRealmRolesForClientScopeForClientAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
			.AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/scope-mappings/realm/available")
			.GetJsonAsync<IEnumerable<Role>>()
			.ConfigureAwait(false);

		public async Task<IEnumerable<Role>> GetEffectiveRealmRolesForClientScopeForClientAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
