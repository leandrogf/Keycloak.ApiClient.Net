...
using Flurl.Http;
using Keycloak.ApiClient.Net.Models.UserStorageProvider;
...
namespace Keycloak.ApiClient.Net
{
    public partial class KeycloakClient
    {
        ...
        [Obsolete("Not working yet")]
        public async Task<SynchronizationResult> TriggerUserSynchronizationAsync(string realm, string storageProviderId, UserSyncActions action) => await GetBaseUrl(realm, true)
        ...
        [Obsolete("Not working yet")]
        public async Task<SynchronizationResult> TriggerLdapMapperSynchronizationAsync(string realm, string storageProviderId, string mapperId, LdapMapperSyncActions direction) => await GetBaseUrl(realm, true)
