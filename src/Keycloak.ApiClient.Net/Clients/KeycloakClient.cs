...
using Keycloak.ApiClient.Net.Models.ClientScopes;
...
namespace Keycloak.ApiClient.Net
{
    public partial class KeycloakClient
    {
        ...
        {
            IFlurlResponse response = await InternalCreateClientAsync(realm, client).ConfigureAwait(false);
        ...
        public async Task<string> CreateClientAndRetrieveClientIdAsync(string realm, Client client)
        {
            ...
            var locationPathAndQuery = response.Headers.FirstOrDefault("Location");
            var clientId = (response.StatusCode >= 200 && response.StatusCode < 300 && !string.IsNullOrEmpty(locationPathAndQuery)) ?
        ...
        public async Task<Client> GetClientAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        public async Task<Credentials> GenerateClientSecretAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        public async Task<Credentials> GetClientSecretAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/client-secret")
            .GetJsonAsync<Credentials>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<ClientScope>> GetDefaultClientScopesAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        [Obsolete("Not working yet")]
        public async Task<string> GetClientProviderAsync(string realm, string clientId, string providerId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/installation/providers/{providerId}")
            .GetStringAsync()
            .ConfigureAwait(false);

        [Obsolete("Not working yet")]
        public async Task<ManagementPermission> GetClientAuthorizationPermissionsInitializedAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        public async Task<long> GetClientOfflineSessionCountAsync(string realm, string clientId)
        {
        ...
        public async Task<IEnumerable<ClientScope>> GetOptionalClientScopesAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        public async Task<GlobalRequestResult> PushClientRevocationPolicyAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/push-revocation")
            .PostAsync(new StringContent(""))
            .ReceiveJson<GlobalRequestResult>()
            .ConfigureAwait(false);

        public async Task<Client> GenerateClientRegistrationAccessTokenAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        [Obsolete("Not working yet")]
        public async Task<User> GetUserForServiceAccountAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/clients/{clientId}/service-account-user")
            .GetJsonAsync<User>()
            .ConfigureAwait(false);

        public async Task<long> GetClientSessionCountAsync(string realm, string clientId)
        {
            var result = await GetBaseUrl(realm, true)
        ...
        public async Task<GlobalRequestResult> TestClientClusterNodesAvailableAsync(string realm, string clientId) => await GetBaseUrl(realm, true)
        ...
        public async Task<IEnumerable<Resource>> GetResourcesOwnedByClientAsync(string realm, string clientId) => await GetBaseUrl(realm, false)
