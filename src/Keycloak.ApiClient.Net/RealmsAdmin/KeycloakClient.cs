...
namespace Keycloak.ApiClient.Net
{
    public partial class KeycloakClient
    {
        ...
        public async Task<IEnumerable<Realm>> GetRealmsAsync(string realm) => await GetBaseUrl(realm, true)
	        .AppendPathSegment($"/admin/realms")
	        .GetJsonAsync<IEnumerable<Realm>>()
	        .ConfigureAwait(false);

        public async Task<Realm> GetRealmAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        public async Task<Client> BasePathForImportingClientsAsync(string realm, string description) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/client-description-converter")
            .PostAsync(new StringContent(description))
            .ReceiveJson<Client>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<IDictionary<string, object>>> GetClientSessionStatsAsync(string realm) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/client-session-stats")
            .GetJsonAsync<IEnumerable<IDictionary<string, object>>>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<ClientScope>> GetRealmDefaultClientScopesAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        public async Task<IEnumerable<Group>> GetRealmGroupHierarchyAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        public async Task<IEnumerable<ClientScope>> GetRealmOptionalClientScopesAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        public async Task<RealmEventsConfig> GetRealmEventsProviderConfigurationAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        public async Task<Group> GetRealmGroupByPathAsync(string realm, string path) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/group-by-path/{path}")
            .GetJsonAsync<Group>()
            .ConfigureAwait(false);

        public async Task<GlobalRequestResult> RemoveUserSessionsAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        public async Task<GlobalRequestResult> PushRealmRevocationPolicyAsync(string realm) => await GetBaseUrl(realm, true)
        ...
        [Obsolete("Use GetRealmUsersManagementPermissionsAsync instead.")]
        public async Task<ManagementPermission> GetRealmUsersManagementPermissionsAsync(string realm) => await GetBaseUrl(realm, true)
