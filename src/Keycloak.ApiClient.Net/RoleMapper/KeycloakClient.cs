...
namespace Keycloak.ApiClient.Net
{
    ...
    {
        public async Task<Mapping> GetRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl(realm, true)
        ...
        public async Task<IEnumerable<Role>> GetRealmRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/groups/{groupId}/role-mappings/realm")
        ...
        public async Task<IEnumerable<Role>> GetAvailableRealmRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/groups/{groupId}/role-mappings/realm/available")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<Role>> GetEffectiveRealmRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/groups/{groupId}/role-mappings/realm/composite")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);

        public async Task<Mapping> GetRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl(realm, true)
        ...
        public async Task<IEnumerable<Role>> GetRealmRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/users/{userId}/role-mappings/realm")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);
        ...
        public async Task<IEnumerable<Role>> GetAvailableRealmRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl(realm, true)
            .AppendPathSegment($"/admin/realms/{realm}/users/{userId}/role-mappings/realm/available")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<Role>> GetEffectiveRealmRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl(realm, true)
